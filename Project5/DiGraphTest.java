...
public class DiGraphTest {
    ...
    public static void main(String[] args) {
        ...
        int vertices, addEdgeFrom, addEdgeTo, deleteEdgeFrom, deleteEdgeTo, from, to;
        String menuItem;
        char menuItem_c;
        boolean quit = false;
        ...
        while (!quit) {
            ...
            switch(menuItem_c) {
                ...
                case 'l':
                    ...
                    to = scanner.nextInt();
                    scanner.nextLine();
                    System.out.println("Length of path is " + dg.lengthOfPath(from, to));
                    break;
                case 's':
                    from = scanner.nextInt();
                    to = scanner.nextInt();
